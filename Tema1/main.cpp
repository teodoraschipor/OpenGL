...
int main(int argc, char* argv[])
{
	...
	glutInitWindowSize(900, 900); //dimensiunile ferestrei
	glutCreateWindow("puncte - OpenGL <<nou>>"); // titlul ferestrei
	glewInit(); // trebuie initializat inainte de a a initializa desenarea
	Initialize();
